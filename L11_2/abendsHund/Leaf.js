...
(function (L11_2_GoldenerHerbst) {
    class Leaf extends L11_2_GoldenerHerbst.Moveable {
        ...
        constructor(_size, _position) {
            ...
            this.velocity = L11_2_GoldenerHerbst.Vector.getRandom(100, 200);
        }
        draw() {
            let nParticles = 15;
            let radiusParticles = 10;
            let particle = new Path2D();
            let gradient = L11_2_GoldenerHerbst.crc2.createRadialGradient(0, 0, 0, 0, 0, radiusParticles);
            particle.arc(0, 0, radiusParticles, 0, 0.9 * Math.PI);
            gradient.addColorStop(0, "red");
            L11_2_GoldenerHerbst.crc2.save();
            L11_2_GoldenerHerbst.crc2.translate(-130 + this.position.x, -70 + this.position.y);
            ...
            for (let drawn = 5; drawn < nParticles; drawn++) {
                ...
                L11_2_GoldenerHerbst.crc2.translate(x, y);
                L11_2_GoldenerHerbst.crc2.fill(particle);
                L11_2_GoldenerHerbst.crc2.restore();
            }
            L11_2_GoldenerHerbst.crc2.restore();
